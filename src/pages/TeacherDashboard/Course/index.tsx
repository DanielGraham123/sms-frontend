...
import { Tab } from "headlessui-dev";
import { LucideProps } from "lucide-react";
import clsx from "clsx";
import { Menu } from "../../../base-components/Headless";
import courseImage from '../../../assets/images/books-course.png'
...
const index = () => {
    ...
    const courseTabs: TabProps[] = [
        { name: 'General', icon: 'Component' },
        { name: 'Meterials', icon: 'Files' },
    ...
    return (
        <>
            <div className="flex items-center intro-y mt-8 mb-3">
                <h2 className="mr-auto text-lg font-medium">Course</h2>
                ...
                <div className="px-5 pt-5 mt-5 intro-y box">
                    <div className="flex flex-col pb-5 -mx-5 border-b lg:flex-row border-slate-200/60 dark:border-darkmode-400">
                        <div className="flex items-center justify-center flex-1 px-5 lg:justify-start">
                            <div className="relative flex-none w-20 h-20 sm:w-24 sm:h-24 lg:w-32 lg:h-32 rounded-full bg-gray-200">
                                <img
                                    alt="Course Picture"
                            ...
                            <div className="ml-5">
                                ...
                                <div className="text-slate-500" dangerouslySetInnerHTML={{ __html: user.course.description }} />
                            </div>
                        </div>
                        <div className="flex-1 px-5 pt-5 mt-6 border-t border-l border-r lg:mt-0 border-slate-200/60 dark:border-darkmode-400 lg:border-t-0 lg:pt-0">
                            ...
                            <div className="grid grid-cols-2 items-center justify-center mt-4 lg:items-start">
                                {
                                    user.course.grades.map((grade: any) => (
                                        <div className="flex items-center truncate sm:whitespace-normal pb-2">
                                            <Lucide icon="AlertOctagon" className="w-4 h-4 mr-2" />
                                            {grade.name}
                                        </div>
                                    ))
                                }
                        ...
                        <div className="flex items-center justify-center flex-1 px-5 pt-5 mt-6 border-t lg:mt-0 lg:border-0 border-slate-200/60 dark:border-darkmode-400 lg:pt-0">
                            <div className="w-20 py-3 text-center rounded-md">
                                <div className="text-xl font-medium text-primary">{user.course.grades.length}</div>
                                <div className="text-slate-500">Classes</div>
                            </div>
                            <div className="w-20 py-3 text-center rounded-md">
                                <div className="text-xl font-medium text-primary">222</div>
                                <div className="text-slate-500">Students</div>
                            </div>
                            <div className="w-20 py-3 text-center rounded-md">
                                <div className="text-xl font-medium text-primary">20</div>
                                <div className="text-slate-500">Assignments</div>
                            </div>
                        </div>
                    </div>
                    <Tab.List
                        className="flex flex-col justify-center text-center sm:flex-row lg:justify-start mb-px"
                    >
                        {courseTabs.map((tab: TabProps, index: number) => (
                            <Tab key={tab.name + "#" + index} as={Fragment}>
                                {
                                    ({ selected }) => (
                                        <button className={clsx(
                                            ...
                                            'px-5 border-b-2 font-medium text-sm flex items-center py-4 cursor-pointer justify-center'
                                        )}>
                                            <Lucide icon={tab.icon} className="w-4 h-4 mr-2" /> {tab.name}
                                        </button>
                                    )
                                }
                            </Tab>
                        ...
                        <div className="grid grid-cols-12 gap-6">
                            ...
                            <div className="col-span-12 intro-y box lg:col-span-6">
                                <div className="p-5 box intro-y">
                                    <div className='flex justify-ceenter'>
                                        <h2 className='font-medium text-lg'>Course Schedule for the Week</h2>
                                    </div>

                                    <div className="py-3 mt-3 mb-5 border-t border-b border-slate-200/60 dark:border-darkmode-400">
                                        <div className="relative">
                                            <div className="flex items-center p-3 -mx-3 transition duration-300 ease-in-out rounded-md cursor-pointer event hover:bg-slate-100 dark:hover:bg-darkmode-400">
                                                ...
                                                <div className="pr-10">
                                                    <div className="truncate event__title">Form 1</div>
                                            ...
                                            <a
                                                ...
                                                href=""
                                            >
                                                <Lucide icon="AlertOctagon" className="w-4 h-4 text-slate-500" />
                                            </a>
                                        </div>
                                        <div className="relative">
                                            <div className="flex items-center p-3 -mx-3 transition duration-300 ease-in-out rounded-md cursor-pointer event hover:bg-slate-100 dark:hover:bg-darkmode-400">
                                        ...
                                        <div className="relative">
                                            <div className="flex items-center p-3 -mx-3 transition duration-300 ease-in-out rounded-md cursor-pointer event hover:bg-slate-100 dark:hover:bg-darkmode-400">
                                                <div className="w-2 h-2 mr-3 rounded-full bg-pending"></div>
                                                <div className="pr-10">
                                                    <div className="truncate event__title">Form 3</div>
                                                    <div className="text-slate-500 text-xs mt-0.5">
                                                        Friday
